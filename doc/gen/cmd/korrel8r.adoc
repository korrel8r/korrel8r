...
----
  ...
  -v, --verbose int          Verbosity for logging (0: notice/error/warn, 1: info/warn, 2: debug, 3: per-request, 4: per-rule, 5: per-query, 9: extra-detail
----

== SEE ALSO

* xref:korrel8r_describe.adoc[korrel8r describe]	 - Documentation for DOMAIN or for all domains.
...
* xref:korrel8r_neighbors.adoc[korrel8r neighbors]	 - Get graph of nearest neighbors
