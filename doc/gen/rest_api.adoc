...
// markup not found, no include::{specDir}console/updates/GET/spec.adoc[opts=optional]
...
// markup not found, no include::{snippetDir}console/updates/GET/http-request.adoc[opts=optional]


// markup not found, no include::{snippetDir}console/updates/GET/http-response.adoc[opts=optional]



// file not found, no * wiremock data link :console/updates/GET/GET.json[]


ifdef::internal-generation[]
===== Implementation

// markup not found, no include::{specDir}console/updates/GET/implementation.adoc[opts=optional]
...
Post the current state of the console so it can be retrieved by an agent via the MCP API. 


// markup not found, no include::{specDir}console/POST/spec.adoc[opts=optional]
...
// markup not found, no include::{snippetDir}console/POST/http-request.adoc[opts=optional]


// markup not found, no include::{snippetDir}console/POST/http-response.adoc[opts=optional]



// file not found, no * wiremock data link :console/POST/POST.json[]


ifdef::internal-generation[]
===== Implementation

// markup not found, no include::{specDir}console/POST/implementation.adoc[opts=optional]
...
Describes the data displayed in the users console.
...
| 
|   String  
| Represents a request to retrieve data for a particular Class. It has 3 parts DOMAIN:CLASS:SELECTOR DOMAIN: name of a domain. CLASS: name of a class in the domain. SELECTOR: domain-specific query string to retrieve selected objects. 
|     
