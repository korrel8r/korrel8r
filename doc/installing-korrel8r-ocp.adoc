...
= Installing Korrel8r on {rh-ocp}

The following steps install Korrel8r on {rh-ocp} by using the {operator}.
...
. In the *Administrator* perspective of the {rh-ocp} web console, navigate to *Operators* -> *Installed Operators*.
