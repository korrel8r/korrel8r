...
NOTE: Get the latest code from the {project}[Korrel8r project]. This guide is available online in {pages}[HTML] and {pages}/ebook.pdf[PDF ebook] format.
