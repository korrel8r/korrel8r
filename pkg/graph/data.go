...
type Node struct {
	...
	// FIXME general attachment mechanism for context? Work out deps?
	Async any
}
...
func (l *Line) FromNode() *Node { return NodeFor(l.Line.From()) }
func (l *Line) ToNode() *Node   { return NodeFor(l.Line.To()) }
