...
korrel8r -c testdata/use_mock_store.yaml neighbors -q 'k8s:Deployment.v1.apps:{"namespace":"openshift-apiserver","name":"apiserver"}' --metric-file neighbors-metrics.json-pretty -o json-pretty > neighbors-out.json
