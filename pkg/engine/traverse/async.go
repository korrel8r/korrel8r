...
func (a async) run(ctx context.Context, start Start, traverse func(v graph.Visitor)) (*graph.Graph, error) {
	...
	defer busy.Wait() // wait for all goroutines.
