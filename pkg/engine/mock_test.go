...
type mockRule struct {
	...
	apply       func(korrel8.Object, *korrel8.Constraint) []string
}
...
func (r mockRule) Apply(start korrel8.Object, c *korrel8.Constraint) ([]string, error) {
	return r.apply(start, c), nil
}

var _ korrel8.Rule = mockRule{} // Implements interface

func rr(start, goal string, apply func(korrel8.Object, *korrel8.Constraint) []string) mockRule {
	return mockRule{
...
func (s mockStore) Get(_ context.Context, q string, r korrel8.Result) error {
