...
Represents a [span](<https://opentelemetry.io/docs/concepts/signals/traces/#spans>). A trace is a set of spans with the same trace\-id, there is no explicit class representing a trace.
