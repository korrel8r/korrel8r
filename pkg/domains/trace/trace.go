...
//
// [Trace]: https://docs.openshift.com/container-platform/latest/observability/network_observability/json-flows-format-reference.html
package trace
...
func (s *store) Get(ctx context.Context, query korrel8r.Query, c *korrel8r.Constraint, result korrel8r.Appender) error {
	...
	return s.Client.Get(ctx, q.Data(), func(e *tempo.Trace) { result.Append(e) })
}
...
func (s *stackStore) Get(ctx context.Context, query korrel8r.Query, c *korrel8r.Constraint, result korrel8r.Appender) error {
	...
	return s.Client.GetStack(ctx, q.Data(), c, func(e *tempo.Trace) { result.Append(e) })
}
