...
type ServerInterface interface {
	// SetConfig Change configuration settings at runtime.
	// (PUT /config)
	SetConfig(c *gin.Context, params SetConfigParams)
	// GetConsole Get current console state.
	// (GET /console)
	GetConsole(c *gin.Context)
	// SetConsole Make console state available to an agent.
	// (PUT /console)
	SetConsole(c *gin.Context)
	// ConsoleEvents SSE event stream of console display updates from an agent.
	// (GET /console/events)
	ConsoleEvents(c *gin.Context)
	// ShowInConsole Send a display update to the console.
	// (PUT /console/events)
	ShowInConsole(c *gin.Context)
	// ListDomainClasses Get the list of classes for a domain.
	// (GET /domain/{domain}/classes)
	ListDomainClasses(c *gin.Context, domain string)
	// ListDomains Get the list of correlation domains.
	// (GET /domains)
	ListDomains(c *gin.Context)
	// GraphGoals Create a correlation graph from start objects to goal queries.
	// (POST /graphs/goals)
	GraphGoals(c *gin.Context, params GraphGoalsParams)
	// GraphNeighbors Create a neighborhood graph around a start object to a given depth.
	// (POST /graphs/neighbors)
	GraphNeighbors(c *gin.Context, params GraphNeighborsParams)
	// GraphNeighbours Create a neighborhood graph around a start object to a given depth.
	// (POST /graphs/neighbours)
	//
	// Deprecated: this operation has been marked as deprecated upstream, but no `x-deprecated-reason` was set
	GraphNeighbours(c *gin.Context, params GraphNeighboursParams)
	// Help Get help about all domains.
	// (GET /help)
	Help(c *gin.Context)
	// HelpDomain Get help about a specific domain.
	// (GET /help/{domain})
	HelpDomain(c *gin.Context, domain string)
	// ListGoals Create a list of goal nodes related to a starting point.
	// (POST /lists/goals)
	ListGoals(c *gin.Context)
	// Objects Execute a query, returns a list of JSON objects.
	// (GET /objects)
...
func (siw *ServerInterfaceWrapper) ListDomainClasses(c *gin.Context) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "domain", c.Param("domain"), &domain, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: "", ValueIsUnescaped: true})
	if err != nil {
